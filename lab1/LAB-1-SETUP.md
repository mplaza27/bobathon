...
Follow the steps here to have the repository set up:
#### [HERE](../PREREQUISITE.md)
...
The technical details aren't important for this lab - we're focusing on learning Bob's capabilities.
